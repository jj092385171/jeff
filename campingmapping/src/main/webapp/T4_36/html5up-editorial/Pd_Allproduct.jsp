				...
				<div id="main">
					...
					<div class="inner">
						...
						<div class="container">
							...
							<form id="form1" name="form1" method="post" action="SelectAllServlet.do"
									...
									<tbody>
										<c:forEach var='Category' items='${AllList}' varStatus="statusX">
											<tr>
												...
												<td>
													<input name="pdid" type="hidden" id="${Category.pdid}"
														value="${Category.pdid}" />
													<input type="button" style="border-radius:60%" name="delete"
														value="修改" onclick="updateProduct(${Category.pdid})" />
												</td>
												<td>
													<input name="pdid" type="hidden" id="${Category.pdid}"
														value="${Category.pdid}" />
													<input type="button" style="border-radius:60%" name="delete"
														value="刪除" onclick="confirmDelete(${Category.pdid})" />
												</td>
					...
					<div class="inner">
						...
						<nav id="menu">
							...
							<ul>
								...
								<li>
									<a
										href="http://localhost:8080/campingmapping/T4_36/html5up-editorial/Pd_Allproduct.jsp">商城維護</a>
								</li>
								<li>
