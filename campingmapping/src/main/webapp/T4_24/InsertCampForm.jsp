                    ...
                    <section>
                        ...
                        <div class="mini-posts">
                            ...
                            <body>
                                ...
                                <form method="post"
                                    action="${pageContext.servletContext.contextPath}/T4_24/InsertCampServlet"
                                    enctype="multipart/form-data">
                                    <div class="row gtr-uniform">
                                        <div class="col-6 col-12-xsmall">
                                            <input type="text" name="campName" id="campName" value="${param.campName}"
                                                placeholder="營地名" />
                                            <div style="color:#FF0000; font-size:60%; display: inline">
                                                ${ErrorMsg.campName}</div>
                                        </div>
                                        <div class="col-6 col-12-xsmall">
                                            <input id='campPictures' name="campPictures" type="file">
                                            <div style="color:#FF0000; font-size:60%; display: inline">
                                        ...
                                        <div class="col-6 col-12-xsmall">
                                            <input type="text" name="location" id="location" value="${param.location}"
                                                placeholder="地址" />
                                            <div style="color:#FF0000; font-size:60%; display: inline">
                                        ...
                                        <div class="col-6 col-12-small">
                                            <c:forEach var='tag' items='${tagList}'>
                                                <input type="checkbox" id="${tag.tagName}" name="tagID"
                                                    value="${tag.tagID}">
                                        ...
                                        <!-- Break -->
                                        <div class="col-12">
                                            <textarea name="discription" id="discription" placeholder="描述"
                                                rows="6"></textarea>
                                        </div>
                                        <!-- Break -->
                                        <div class="col-12">
                        ...
                        <div class="mini-posts">
                            ...
                            <form method="post"
                                action="${pageContext.servletContext.contextPath}/T4_24/InsertSiteByCampIDPageServlet">
                                <div class="row gtr-uniform">
                                    <div class="col-6 col-12-xsmall">
                                        <input type="text" name="campID" id="campID" value="${param.campID}"
                                            placeholder="營地編號" />
                                        <div style="color:#FF0000; font-size:60%; display: inline">
                                            ${ErrorMsg.campName}</div>
                                    </div>
