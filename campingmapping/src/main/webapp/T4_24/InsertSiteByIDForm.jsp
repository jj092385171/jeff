...
<body>
	<form name="InsertSiteByIDForm" action="<c:url value='/T4_24/InsertSiteByIDServlet' />" method="POST" enctype="multipart/form-data">
		<table border="1">
			<thead>
				<tr bgcolor='lightblue'>
					<th height="60" colspan="2" align="center" ><h2>新增營區位資料</h2></th>
				</tr>
			</thead>
			<tbody>
				<tr bgcolor='lightgreen'>
					<td width="120" height="40">營區位名:</td>
					<td width="600" height="40" align="left"><input id='siteName'
						style="text-align: left" name="siteName" value="${param.siteName}" type="text" size="14">
				...
				<tr bgcolor='lightgreen'>
					...
					<td width="600" height="40" align="left"><input id='totalSites' name="totalSites" value="${param.totalSites}"
						type="text" size="20">
				...
				<tr bgcolor='lightgreen'>
					...
					<td width="600" height="40" align="left"><input id='siteMoney' name="siteMoney" value="${param.siteMoney}"
						type="text" size="20">
				...
				<tr bgcolor='lightgreen'>
					...
					<td width="600" height="40" align="left"><input id='campID' name="campID" readonly="readonly" value='${ cctBean.campID }'
						type="text" size="20">
					</td>
				</tr>
				<tr bgcolor='lightblue'>
...
<div class='class1'>
	<form name="InsertSiteByIDForm">
		...
		縣市XXX:<c:forEach var='city' items='${cityList}'>
			   	<input type="radio" name="cityIDXXX" readonly="readonly" checked value="${city.cityID}" />${city.cityName}
			</c:forEach><br>
		...
		標籤XXX: <c:forEach var='tag' items='${cctBean.tagList}'>
				<input type="checkbox" name="tagIDXXX" readonly="readonly" checked value="${tag.tagID}" />${tag.tagName}
			 </c:forEach><br>
