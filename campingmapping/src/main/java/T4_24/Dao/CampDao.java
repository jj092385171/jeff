...
public class CampDao {
		...
		public void deletdByCampID(int campID) throws SQLException {
			...
			System.out.println("刪除營地");
		}
		
		//修改營地資料
		public BigDecimal updateCampByID() throws SQLException{
			
			String sql = "update camp set campName = ? set campPictures = ? set discription = ? where campID = ?";
			PreparedStatement preState = conn.prepareStatement(sql);
			
			preState.setString(1, sql);
		}
