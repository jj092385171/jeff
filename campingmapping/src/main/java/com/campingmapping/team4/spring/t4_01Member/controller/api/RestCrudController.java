...
import com.campingmapping.team4.spring.t4_01Member.model.dao.repository.ProfilesRepository;
...
public class RestCrudController {
	...
	@PutMapping("/profiles/up/{pid}")
	@ResponseBody
	public String processDelectAction(@PathVariable("pid") int pid, @RequestParam("userName") String userName,
			@RequestParam("userAddress") String userAddress, @RequestParam("userPhone") String userPhone) {
		Profiles p2 = new Profiles(pid, userName, userAddress, userPhone);
		pService.delete(p2);
		return "Update OK";
