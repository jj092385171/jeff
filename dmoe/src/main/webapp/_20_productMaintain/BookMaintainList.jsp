...
<div id='main' align='center'>
 <font color='red' size='-1'>${successMsg.success}${BookDeleteMsg}</font><br/>
...
<table style="border: 3px solid black; width: 690px">
	<!--   購物車的標題   -->
	<TR>
		<TD colspan='3'>
		<TABLE width="680"  style="background: #ffE4C4">
			<TR height='5'>
				<TD align='center'>&nbsp;</TD>
			</TR>
			<TR height='30'>
		...
		<tr height='18' bgColor="${rowColor}">
			...
			<td rowspan='3' width='80'><!-- 
              ...
              --> <img height='100' width='80'
				src="<c:url value='/_00_init/getBookImage?id=${entry.value.bookId}' />"></td>
		</tr>
					...
					<c:choose>
						<c:when test="${ entry.value.discount != 1 }">
						   <TD width='260' align="left"><Font color='red'>
							 ...
							 value="${entry.value.listPrice*entry.value.discount}"
...
<div id="bpaging" style="position:fixed; top:450px;left:130px;">
<!-- 以下為控制第一頁、前一頁、下一頁、最末頁 等超連結-->
<table border="1">
	<tr align="center">
		<td width='80' height='20'><c:if test="${pageNo > 1}">
			<div id="blfirst"><a
				href="<c:url value='/_20_productMaintain/DisplayPageProducts?pageNo=1' />"> <img
				border='0' alt='第一頁' height='30' width='30'
				src="<c:url value='/images/first-icon.png' />" /> </a></div>
				
		</c:if></td>
		<td width='80'><c:if test="${pageNo > 1}">
			<div id="blprev"><a
				href="<c:url value='/_20_productMaintain/DisplayPageProducts?pageNo=${pageNo-1}' />">
			<img border='0' alt='前一頁' height='30' width='30'
				src="<c:url value='/images/prev-icon.png' />" /></a></div>
		</c:if></td>
		...
		<td width='80'><c:if test="${pageNo != totalPages}">
			...
			<img border='0' alt='下一頁' height='30' width='30'
				src="<c:url value='/images/next-icon.png' />" /> </a></div>
				
		</c:if></td>
		<td width='80'><c:if test="${pageNo != totalPages}">
			<div id="bllast"><a
				href="<c:url value='/_20_productMaintain/DisplayPageProducts?pageNo=${totalPages}' />">
			<img border='0' alt='最末頁' height='30' width='30'
				src="<c:url value='/images/last-icon.png' />" /> </a></div>
