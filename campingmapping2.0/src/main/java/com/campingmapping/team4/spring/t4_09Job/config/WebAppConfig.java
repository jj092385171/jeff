package com.campingmapping.team4.spring.t4_09Job.config;
...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = "com.campingmapping.team4.spring.t4_09Job")
public class WebAppConfig implements WebMvcConfigurer {
	...
	public InternalResourceViewResolver viewResolver() {
		...
		irvr.setPrefix("/WEB-INF/pages/t4_09job");
		irvr.setSuffix(".jsp");
		return irvr;
	}
