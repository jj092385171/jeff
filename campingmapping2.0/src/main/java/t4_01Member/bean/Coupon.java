...
public class Coupon {
	...
	public String toString() {
		return String.format(
				"Coupon [couponID=%s, couponCode=%s, couponName=%s, couponType=%s, couponAmount=%s, couponUsed=%s, couponRule=%s, startDate=%s, endDate=%s, createDate=%s]",
				couponID, couponCode, couponName, couponType, couponAmount,
				couponUsed, couponRule, startDate, endDate, createDate);
	}
}
