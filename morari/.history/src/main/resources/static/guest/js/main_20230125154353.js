...
window.onload = function () {
    ...
    fetch("/morari/api/auth/state", {
        ...
        .then(loginstate => {
            if (loginstate) {
                // 登入
                document.getElementById("loginstate").innerHTML = ' <a class="fa fa-user" onclick="toggleDropdown()">登入</a> <div class="dropdown-content" id="dropdown-content" style="display: none;"> <a href="#">個人資料</a><a href="#">登出</a></div>';
            } else {
                // 未登入
