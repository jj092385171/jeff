<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	...
	<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
		...
		<body>
			<div>
				<a href="/indexShowAllCamp.controller"><strong>營地_營區位管理</strong></a>
			</div>
			...
			<table>
				...
				<tbody>
					<c:forEach var='camp' items='${allCamps}'>
						<tr>
							<td>${ camp.campID }</td>
							<td><a href="/sitesOfCamp.controller/${ camp.campID }">${
									camp.campName }</a></td>
							<td>${ camp.city.cityID }</td>
							<td>${ camp.city.cityName }</td>
							<td>${ camp.location }</td>
							<td>
								<img width="80" height="100" src="/getCampPicture/${camp.campID}" />
							</td>
			...
			<div>
				<a href="/queryPage.controller">&emsp;查詢&emsp;營地_營區位</a>
				<br>
				<a href="/insertPage.controller">&emsp;新增&emsp;營地_營區位</a>
				<br>
				<a href="/indexShowAllCamp.controller">回首頁</a>
			</div>
