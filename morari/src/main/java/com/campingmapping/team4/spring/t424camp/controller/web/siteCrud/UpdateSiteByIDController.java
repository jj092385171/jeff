...
public class UpdateSiteByIDController {
	...
	public String updateSiteByID(@RequestParam("siteID") Integer siteID,
			...
			@RequestParam("siteMoney") @Nullable String siteMoney, @RequestParam("campID") Integer campID, Model m)
		...
		Site site = siteService.update(siteID, siteName, fileName, Integer.valueOf(totalSites),
				Integer.valueOf(siteMoney), campID);
