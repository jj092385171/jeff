	...
	fetch("/morari/utils/getuid")
		...
		.then(data => {
			...
			$("#campId").click(function () {
				$('#campID').empty("");
				var div = $('#campID');
				var input = "<form>請輸入會員編號<input type='text' id='uuid'><input  class='btn btn-success btn-icon-split' type='button' value='查詢' onclick='submitForm()'></form> <input class='btn btn-success btn-icon-split' type='button' value='帳號1' id='fastinput1'><input class='btn btn-success btn-icon-split' type='button' value='帳號2' id='fastinput2'>";
				div.append(input);
				// 一鍵輸入 
