						...
						"columns": [
							...
							},
							{
								...
								render: function (data, type, row) {
									return '<button style=\"border:none;background-color:transparent\"  onclick=\"edituser(\''+row.uid+'\')\"><a class=\"btn btn-warning btn-circle\"><i class=\"fas fa-user-edit\"></i></a></button>'									
							...
							},
							{
								...
								render: function (data, type, row) {
									return  '<button style=\"border:none;background-color:transparent\"   onclick=\"deluser(\''+row.uid+'\')\"><a  class=\"btn btn-danger btn-circle\"><i class=\"fas fa-trash-alt\"></i></a></button>'
